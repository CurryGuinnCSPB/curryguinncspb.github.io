...
tags:
  ...
  - Alan Turing
excerpt: "A response to the Nature article 'Does AI already have human-level intelligence? The evidence is clear,' examining whether modern large language models already meet a reasonable definition of artificial general intelligence."
header:
  overlay_image: /assets/images/Nature_AI.jpg
  caption: "Human-Level Artificial Intelligence (Illustration, Jacey, Nature Magazine)"
toc: true
toc_label: "On this page"
---

<p class="notice--primary"><strong>“By reasonable standards… we have artificial systems that are generally intelligent.”</strong></p>
